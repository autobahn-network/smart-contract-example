...
// **
// Our credits go to https://github.com/encoderafat/disperse
// **
...
contract Disperse {
    function disperseBNB(address payable[] calldata recipients, uint256[] calldata values) external payable {
